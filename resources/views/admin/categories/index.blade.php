...
@section('content')
    <div class="w-full font-['Manrope']  text-[#1e1f22]">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8 pb-4 border-b border-gray-100">
            <div>
                <h1 class="text-2xl font-normal tracking-wider  text-[#1e1f22]">Категории услуг</h1>
                <p class="text-xs text-[#7c7e8c] font-light mt-1">Управление разделами и классификацией процедур студии</p>
            </div>
            <a href="{{ route('admin.categories.create') }}" class="inline-flex items-center justify-center px-5 py-3 bg-[#ff5c8a] hover:bg-[#e04b75] text-white text-xs tracking-wider  font-normal rounded-xl transition-all duration-300 shadow-sm hover:cursor-pointer whitespace-nowrap">
                + Добавить категорию
            </a>
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    ...
                    <tr class="border-b border-[#f1f1f5] bg-[#f8f8fa]">
                        <th scope="col" class="px-6 py-4 text-sm  text-[#7c7e8c] font-medium">Название</th>
